...
<?php endif; ?>
	...
	<input type="hidden" class="ipt_fsqm_timer_data" id="ipt_fsqm_timer_data_<?php echo $this->form_id; ?>" value="<?php echo esc_attr( json_encode( (object) $timer ) ); ?>" />
	<div style="display: none;" class="ipt_uif_hidden_init">
...
?>
<input type="hidden" name="<?php echo $name_prefix; ?>[m_type]" id="<?php echo $this->ui->generate_id_from_name( $name_prefix . '[m_type]' ); ?>" value="<?php echo $element_data['m_type']; ?>" class="ipt_fsqm_hf_m_type" />
<input type="hidden" name="<?php echo $name_prefix; ?>[type]" id="<?php echo $this->ui->generate_id_from_name( $name_prefix . '[type]' ); ?>" value="<?php echo $element_data['type']; ?>" class="ipt_fsqm_hf_type" />
		<?php
	}
}
