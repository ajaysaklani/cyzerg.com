        ...
        while ( $loop->have_posts() ) {
            ...
            */
            ...
            if ( $params['show_category'] === 'true' ) {
                ...
                if ( $categories_list ) {
                    $category = '<span class="wp-posts-carousel-categories">';
            ...
            */
            if ( $params['show_created_date'] === 'true' ) {
                $created_date = '<span class="wp-posts-carousel-created-date">';
            ...
            */
            ...
            if ( $params['show_description'] === 'excerpt' ) {
                ...
                $description = '' . ($params['allow_shortcodes'] === 'true' ? do_shortcode(get_the_content('', true)) : get_the_content()) . '';
            }
            ...
            $out.= '<div class="wp-posts-carousel-slide slides-' . $params['items_to_show'] . '">';
                $out.= '<div class="wp-posts-carousel-container">';
                    ...
                    $out.= '<div class="wp-posts-carousel-details">';
						...
						$out.= '<div class="wp-posts-carousel-desc">';
