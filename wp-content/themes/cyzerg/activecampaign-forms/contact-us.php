...
<div class="f-left"><input type="text" name="fullname" placeholder="Full Name:" size="40" required aria-required=”true”><br>
...
</div><div class="f-right"><textarea class="wpcf7-textarea" cols="40" name="field[1]" placeholder="How may we help you?" rows="10"></textarea><br>
<input type="submit" value="Send Message" name="submit" class="wpcf7-submit"></div>
</form>
