...
<div class="form-inner" style="padding:0;"><input type="text" name="fullname" placeholder="Full Name:" size="40" required aria-required=”true” style="margin-left:-10px;"><br>
    ...
    <input type="text" name="phone" placeholder="Phone Number:" size="40" required aria-required=”true” pattern="(\+\d*)?[\( ]?\d{3}[-\) ]?\d{3}[- ]?\d{4}"  title="format: 555-555-1212" style="margin-left:-10px;"><br>
        <textarea class="wpcf7-textarea" cols="40" name="field[8]" placeholder="How may we help you?" rows="6" style="margin-left:-10px;height:110px;"></textarea><br>
        <input type="submit" value="Get My Assessment" name="submit" class="wpcf7-submit" style="margin-left:-10px;padding: 10px; background:#229445;box-sizing:content-box;width:100%;max-width: 377px;">
</div>
</form>
<script>
    (function($) {
