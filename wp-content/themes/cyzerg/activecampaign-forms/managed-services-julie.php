<form id="_form_1068" accept-charset="utf-8" action="//cyzerg.activehosted.com/proc.php" enctype="multipart/form-data" method="post" _lpchecked="1">
    <h3><?php echo $h3; ?></h3>
<div style="display:none;">
    <input type="hidden" name="f" value="1068"><p></p>
...
<div class="form-inner" style="padding:0;"><input type="text" name="fullname" placeholder="Full Name:" size="40" required aria-required=”true” style="margin-left:-10px;"><br>
    ...
    <input type="text" name="phone" placeholder="Phone Number:" size="40" required aria-required=”true” pattern="(\+\d*)?[\( ]?\d{3}[-\) ]?\d{3}[- ]?\d{4}"  title="format: 555-555-1212" style="margin-left:-10px;"><br>
        <textarea class="wpcf7-textarea" cols="40" name="field[6]" placeholder="How may we help you?" rows="6" style="margin-left:-10px;height:110px;"></textarea><br>
...
<script>
    (function($) {
            $(function(){
                if($(window).width()>980) {
                    $('#_form_1068').closest('.et_pb_column_1_3').hcSticky({innerTop:-90});
                }
            });
    })(jQuery);
</script>
